<ul id="nav">
    ...
    <% 
        IF Session("credit.allowAdd") THEN 
            IF Session("UseBranchSecurity") = "N" OR (Session("UseBranchSecurity") = "Y" AND branchAccessCount > 0) THEN    
    %>
    ...
    <li><a href="#" class="menu" id="mmenu6" onmouseover="mopen(6);" onmouseout="mclosetime();">Notices</a>
    ...
    <% END IF %>
    <li><a href="logoff.asp" class="menu" id="mmenu9">Sign Out</a></li>
</ul>